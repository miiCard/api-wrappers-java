...
import com.miicard.consumers.service.v1.financial.impl.FinancialRefreshStatusImpl;

@SuppressWarnings("restriction")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "MiiApiResponseOfFinancialRefreshStatus", propOrder = {
    "data",
    "errorCode",
    "errorMessage",
    "isTestUser",
...
public class MiiApiResponseOfFinancialRefreshStatus {
	
    @XmlElement(name = "Data", nillable = true)
	private FinancialRefreshStatusImpl data;
	...
	public FinancialRefreshStatusImpl getData() {
		return data;
	}

	public void setData(FinancialRefreshStatusImpl data) {
		this.data = data;
	}
